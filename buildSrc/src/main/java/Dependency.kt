object Dependency {
    ...
    object Kotlin {
        const val LANG_VERSION: String = "1.6.21"
    ...
    object Jetpack {
        ...
        object Compose {
            ...
            const val FOUNDATION: String =
                "androidx.compose.foundation:foundation:$FOUNDATION_VERSION"
            ...
            const val MATERIAL_ICON: String =
                "androidx.compose.material:material-icons-core:$MATERIAL_ICON_VERSION"

            private const val MATERIAL_ICON_EXT_VERSION: String = "1.0.5"
            const val MATERIAL_ICON_EXT: String =
                "androidx.compose.material:material-icons-extended:$MATERIAL_ICON_EXT_VERSION"
            ...
            const val LIVE_DATA: String =
                "androidx.compose.runtime:runtime-livedata:$LIVE_DATA_VERSION"
        ...
        private const val DATASTORE_VERSION: String = "1.0.0"
        const val DATASTORE: String = "androidx.datastore:datastore-preferences:$DATASTORE_VERSION"
    ...
    object Firebase {
        private const val BOM_VERSION: String = "26.3.0"
    ...
    const val CHUCKER_RELEASE: String =
